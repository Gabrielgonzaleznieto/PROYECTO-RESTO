...
public class RegistroEmpleados extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        int valor = Integer.parseInt(JOptionPane.showInputDialog(this, "Introduce el DNI del empleado "));

<<<<<<< HEAD
        String mostrar = "SELECT * FROM empleados WHERE dni_empleado= " + valor + "";
        String[] Titulos = {"Dni_empleado", "Nombre", "Edad", "Referencias", "Sueldo", "Contraseña", "Mesas", "Rango", "Telefono", "E_mail"};
=======
...
>>>>>>> efd488a7c5f167312f236678078424b63a42a29f
        ...
        try {
            ...
            while (rs.next()) {
                Datos[0] = rs.getString("dni_empleado");
                Datos[1] = rs.getString("nombre");
                Datos[2] = rs.getString("edad");
                Datos[3] = rs.getString("referencias");
                Datos[4] = rs.getString("sueldo");
                Datos[5] = rs.getString("contraseña");
                Datos[6] = rs.getString("mesas");
                Datos[7] = rs.getString("rango");
