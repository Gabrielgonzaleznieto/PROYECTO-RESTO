...
import proyecto_restaurante.Formularios.Clientes;   //Aca importo el Formulario de Clientes.
import proyecto_restaurante.Formularios.ModificarClientes; //Aca importo el Formulario de Modificar Clientes.
...
public class RegistroClientes extends javax.swing.JFrame {
    ...
    ModificarClientes mf = new ModificarClientes();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 70, 510, 40));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        int valor = Integer.parseInt(JOptionPane.showInputDialog(this, "Introduce el DNI del Cliente "));

        String mostrar = "SELECT * FROM cliente WHERE dni_cliente = " + valor + "";
        String[] Titulos = {"Dni_cliente", "Nombre", "telefono", "e_mail"};
