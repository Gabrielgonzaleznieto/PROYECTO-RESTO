...
public class CancelacionReservas extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        String[] Titulos = {"id_res", "numeropersonas", "fecha", "mesas", "costo", "dni_cliente", "dni_empleado"};
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Datos[1] = rs.getString("numeropersonas");
                Datos[2] = rs.getString("fecha");
                Datos[3] = rs.getString("mesas");
                Datos[4] = rs.getString("costo");
                Datos[5] = rs.getString("dni_cliente");
                Datos[6] = rs.getString("dni_empleado");
    ...
    private void tabla() {
        ...
        modelotabla.setColumnIdentifiers(new Object[]{"id_reservacion", "Numero_personas", "Fecha", "Mesas", "Costo", "dni_cliente", "dni_empleado"});
        try {
            while (rs.next()) {
                modelotabla.addRow(new Object[]{rs.getString("id_res"), rs.getString("numeropersonas"), rs.getString("fecha"), rs.getString("mesas"), rs.getString("costo"), rs.getString("dni_cliente"), rs.getString("dni_empleado")});
            }
            jTable1.setModel(modelotabla);
        } catch (Exception e) {
